...
lem_subst_tv_wf_wfrefn g g' a t_a k_a p_g_ta p_env_wf t k (WFRefn env b p_env_b ps nms mk_p_env'_p_bl)
        ...
        Base -> lem_push_wf (concatE g (esubFTV a t_a g')) t_a {-Base-} p_gg'ta_ta
          ...
          where
            ...
            mk_pf_pta_bl y = lem_subst_tv_pftyp (erase_env g) (FCons y (FTBasic b) (erase_env g')
                               ...
                               k_a p_g_er_ta p_er_yenv_wf (unbindP y ps) 
...
lem_subst_tv_wf_wfvar g g' a t_a k_a p_g_ta p_env_wf t k (WFVar1 _env' a' k_a') 
  = case g' of
      ...
      (ConsT _a' _ka' g'') -> WFVar1 (concatE g (esubFTV a t_a g''))
                                     ...
                                     ? lem_psubFTV_notin a t_a PEmpty 
lem_subst_tv_wf_wfvar g g' a t_a k_a p_g_ta p_env_wf t k p_g_t@(WFVar2 _env' a'_ k_a' p_env'_a' y t_y) 
  = case g' of 
        ...
        False -> WFVar2 (concatE g (esubFTV a t_a g'')) a' k_a' p_gg''_a' y (tsubFTV a t_a t_y)
          where
            ...
            p_gg''_a' = lem_subst_tv_wf g g'' a t_a k_a p_g_ta p_env'_wf 
                                        ...
                                        ? lem_psubFTV_notin a t_a PEmpty
lem_subst_tv_wf_wfvar g g' a t_a k_a p_g_ta p_env_wf t k p_g_t@(WFVar3 _env' a'_ k_a' p_env'_a' a1 k_a1) 
  = case g' of
...
lem_subst_tv_wf_wffunc :: Env -> Env -> Vname -> Type -> Kind -> WFType -> WFFE 
                           -> Type -> Kind -> WFType -> WFType
lem_subst_tv_wf_wffunc g g' a t_a k_a p_g_ta p_env_wf t k (WFFunc env t_z k_z p_env_tz t' k' nms mk_p_yenv_t')  
  = WFFunc (concatE g (esubFTV a t_a g')) (tsubFTV a t_a t_z) k_z p_g'g_tzta
      ...
      where
        ...
        mk_p_yg'g_t'ta y = lem_subst_tv_wf g (Cons y t_z g') a t_a k_a p_g_ta p_yenv_wf
...
lem_subst_tv_wf_wfexis :: Env -> Env -> Vname -> Type -> Kind -> WFType -> WFFE 
                           -> Type -> Kind -> WFType -> WFType
lem_subst_tv_wf_wfexis g g' a t_a k_a p_g_ta p_env_wf t k (WFExis env t_z k_z p_env_tz t' k' nms mk_p_yenv_t')  
...
lem_subst_tv_wf_wfpoly :: Env -> Env -> Vname -> Type -> Kind -> WFType -> WFFE 
                              -> Type -> Kind -> WFType -> WFType
lem_subst_tv_wf_wfpoly g g' a t_a k_a p_g_ta p_env_wf t k (WFPoly _env k_a1 t' k_t' nms mk_p_a1env_t') 
  = WFPoly (concatE g (esubFTV a t_a g')) k_a1 (tsubFTV a t_a t') k_t' nms' mk_p_a1gg'_t'
      where
        ...
        mk_p_a1gg'_t' a1 = lem_subst_tv_wf g (ConsT a1 k_a1 g') a t_a k_a p_g_ta p_a1env_wf
