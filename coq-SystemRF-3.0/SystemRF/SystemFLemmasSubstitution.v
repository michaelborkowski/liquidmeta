...
Proof. apply ( HasFtype_ind 
 (fun (g'xg : fenv) (e : expr) (t : ftype) => 
  ...
  - (* FTNil *) apply FTNil with k; apply lem_strengthen_wfft with x t_x;
    assumption.
  - (* FTCons *) apply FTCons; apply H0 with t_x || apply H2 with t_x; trivial.
...
Proof. apply ( HasFtype_ind 
 (fun (g'ag : fenv) (e : expr) (t : ftype) => 
  ...
  - (* FTNil *) apply FTNil with k; apply lem_subst_tv_wfft with k_a; trivial.
  - (* FTCons *) apply FTCons; apply H0 with k_a || apply H2 with k_a; trivial.
