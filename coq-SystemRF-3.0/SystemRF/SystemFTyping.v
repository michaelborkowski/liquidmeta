...
Inductive HasFtype : fenv -> expr -> ftype -> Prop := 
    ...
    | FTNil  : forall (g : fenv) (t : ftype) (k:kind), 
          WFFT g t k -> HasFtype g Nil (FTList t)
    | FTCons : forall (g : fenv) (eH eT : expr) (t : ftype),
          HasFtype g eH t -> HasFtype g eT (FTList t) -> HasFtype g (Cons eH eT) (FTList t)
