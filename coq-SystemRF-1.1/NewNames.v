...
Fixpoint fv (e0:expr) : names := 
    ...
    | (Switch e cs)   => union (fv e) (fvA cs)
    end

with fvA (cs : alts) : names :=
    match cs with
    | AEmpty          => empty
    | (ACons dc e cs) => union (fv e) (fvA cs)
    end

with free (t0:type) : names :=
    match t0 with
    | (TRefn b   rs)     => fvP rs
    | (TData tc t rs)    => union (free t) (fvP rs)
...
Fixpoint ftv (e0:expr) : names := 
    ...
    | (Switch e cs)   => union (ftv e) (ftvA cs) 
    end

with ftvA (cs:alts) : names :=
    match cs with
    | AEmpty          => empty
    | (ACons dc e cs) => union (ftv e) (ftvA cs)
    end
...
with freeTV (t0:type) : names :=
    ...
    | (TData tc t r)     => union (freeTV t) (ftvP r)
...
Lemma fv_open_at_intro : ( forall (e:expr) (j:index) (y:vname) ,
  ...
  forall (cs:alts) (j:index) (y:vname) ,
    Subset (fvA cs) (fvA (openA_at j y cs)) ) * ((
...
Proof. apply ( syntax_mutind
  ( fun e : expr => forall (j:index) (y:vname) ,
    Subset (fv e) (fv (open_at j y e))  )
  ( fun cs : alts => forall (j:index) (y:vname) ,
    Subset (fvA cs) (fvA (openA_at j y cs)) )
...
Lemma fv_unbind_intro : ( forall (e:expr) (y:vname) ,
  ...
  forall (cs:alts) (y:vname) ,
    Subset (fvA cs) (fvA (unbindA y cs)) ) * ((
...
Lemma ftv_open_at_intro : ( forall (e:expr) (j:index) (y:vname) ,
  ...
  forall (cs:alts) (j:index) (y:vname) ,
    Subset (ftvA cs) (ftvA (openA_at j y cs)) ) * ((
  forall (t:type) (j:index) (y:vname) ,
...
Lemma ftv_unbind_intro : ( forall (e:expr) (y:vname) ,
  ...
  forall (cs:alts) (y:vname) ,
    Subset (ftvA cs) (ftvA (unbindA y cs)) ) * ((
  forall (t:type) (y:vname) ,
...
forall (cs:alts) (j:index) (a:vname) ,
  Subset (fvA cs) (fvA (open_tvA_at j a cs)) ) * ((
...
Proof. apply ( syntax_mutind
  ( fun e : expr => forall (j:index) (a:vname) ,
    Subset (fv e) (fv (open_tv_at j a e))  )
  ( fun cs : alts => forall (j:index) (a:vname) ,
    Subset (fvA cs) (fvA (open_tvA_at j a cs)) )
...
Lemma fv_unbind_tv_intro : ( forall (e:expr) (a:vname) ,
  ...
  forall (cs:alts) (a:vname) ,
    Subset (fvA cs) (fvA (unbind_tvA a cs)) ) * ((
...
Lemma ftv_open_tv_at_intro : ( forall (e:expr) (j:index) (a:vname) ,
  ...
  forall (cs:alts) (j:index) (a:vname) ,
    Subset (ftvA cs) (ftvA (open_tvA_at j a cs)) ) * ((
  forall (t:type) (j:index) (a:vname) ,
...
Lemma ftv_unbind_tv_intro : ( forall (e:expr) (a:vname) ,
  ...
  forall (cs:alts) (a:vname) ,
    Subset (ftvA cs) (ftvA (unbind_tvA a cs)) ) * ((
  forall (t:type) (a:vname) ,
...
Lemma fv_subFV_elim : ( forall (e:expr) (x:vname) (v:expr),
  ...
  forall (cs:alts) (x:vname) (v:expr),
    Subset (fvA (asubFV x v cs)) (union (diff (fvA cs) (singleton x)) (fv v)) ) * ((
...
Proof. apply ( syntax_mutind
  ( fun e : expr => forall (x:vname) (v:expr),
    Subset (fv (subFV x v e)) (union (diff (fv e) (singleton x)) (fv v))  )
  ( fun cs : alts => forall (x:vname) (v:expr),
    Subset (fvA (asubFV x v cs)) (union (diff (fvA cs) (singleton x)) (fv v)) )
...
Lemma ftv_subFV_elim : ( forall (e:expr) (x:vname) (v:expr),
  ...
  forall (cs:alts) (x:vname) (v:expr),
    Subset (ftvA (asubFV x v cs)) (union (ftvA cs) (ftv v)) ) * ((
  forall (t:type) (x:vname) (v:expr),
...
Proof. intros; destruct t_a; simpl in H; try contradiction; unfold push.
  ...
  - (* TData *) simpl. apply subset_union_intro_l.
    * apply subset_trans with (union (free t_a) (fvP ps0));
      apply subset_union_intro_r.
    * apply subset_trans with (union (fvP ps) (fvP ps0));
      try apply fv_strengthen_elim; apply subset_union_both;
      try apply subset_union_intro_r; apply subset_refl.
...
Proof. intros; destruct t_a; simpl in H; try contradiction; simpl.
  ...
  - (* TData *) apply subset_union_intro_l.
    * apply subset_trans with (union (freeTV t_a) (ftvP ps0));
      apply subset_union_intro_r.
    * apply subset_trans with (union (ftvP ps) (ftvP ps0));
      try apply ftv_strengthen_elim; apply subset_union_both;
      try apply subset_union_intro_r; apply subset_refl.
  - (* TFunc *) apply subset_union_intro_r.
  - (* TPoly *) apply subset_union_intro_r.
  Qed.
...
Lemma fv_subFTV_elim : ( forall (e:expr) (a:vname) (t_a:type),
  ...
  forall (cs:alts) (a:vname) (t_a:type),
    noExists t_a -> Subset (fvA (asubFTV a t_a cs)) (union (fvA cs) (free t_a)) ) * ((
...
Proof. apply ( syntax_mutind
  ( fun e : expr => forall (a:vname) (t_a:type),
    noExists t_a -> Subset (fv (subFTV a t_a e)) (union (fv e) (free t_a))  )
  ( fun cs : alts => forall (a:vname) (t_a:type),
    noExists t_a -> Subset (fvA (asubFTV a t_a cs)) (union (fvA cs) (free t_a)) )
...
Lemma ftv_subFTV_elim : ( forall (e:expr) (a:vname) (t_a:type),
  ...
  forall (cs:alts) (a:vname) (t_a:type),
    noExists t_a  
      -> Subset (ftvA (asubFTV a t_a cs)) (union (diff (ftvA cs) (singleton a)) (freeTV t_a)) ) * ((
  forall (t:type) (a:vname) (t_a:type),
    noExists t_a 
