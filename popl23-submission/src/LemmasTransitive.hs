...
lem_sub_trans_sbase :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_sbase g p_g_wf t k p_g_t t' t'' k'' p_g_t''
...
{-@ lem_sub_trans_sfunc :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' } 
             / [tdepth t + tdepth t' + tdepth t'', 0] @-}
lem_sub_trans_sfunc :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_sfunc g p_g_wf t k p_g_t t' t'' k'' p_g_t''
  ...
  = SFunc g s1 s3 p_s3_s1 t1 t3 nms'' mk_p_z3g_t1_t3
      where
        ...
        mk_p_z3g_t1_t3 z = lem_sub_trans (Cons z s3 g) p_z3g_wf  (unbindT z t1) k_t1 p_w3g_t1 
                               (unbindT z t2) (unbindT z t3) k_t3 (mk_p_w3g_t3 z)
                               p_y3g_t1_t2 (mk_p_z3g_t2_t3 z)
          where
        ...
        nms''            = unionEnv (union (union nms nms') (union nms1 nms3)) g
...
{-@ lem_sub_trans_spoly :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 0] @-}
lem_sub_trans_spoly :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_spoly g p_g_wf t k p_g_t t' t'' k'' p_g_t''
...
{-@ lem_sub_trans_switnR :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 0] @-}
lem_sub_trans_switnR :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_switnR g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t'
  ...
  = SWitn g v_y s_y p_vy_sy t s'' p_g_t_s''vy
      where
        ...
        p_g_t_s''vy = lem_sub_trans g p_g_wf t k p_g_t t' (tsubBV v_y s'') k'' 
...
{-@ lem_sub_trans_switnbind :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 0] @-}
lem_sub_trans_switnbind :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_switnbind g p_g_wf t k p_g_t t' t'' k'' p_g_t''
...
{-@ lem_sub_trans_sbindL :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 0] @-}
lem_sub_trans_sbindL :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_sbindL g p_g_wf t k p_g_t t' t''_ k'' p_g_t''
...
lem_sub_trans_go_sbase :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_go_sbase  g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''@(SBase {})
  = lem_sub_trans_sbase g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans_go_sbase   g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''@(SWitn {})
  = lem_sub_trans_switnR g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''
lem_sub_trans_go_sbase g _ t _ _ t' t'' _ _ (SBase {}) (SFunc {}) = impossible ""
lem_sub_trans_go_sbase g _ t _ _ t' t'' _ _ (SBase {}) (SBind {}) = impossible ""
lem_sub_trans_go_sbase g _ t _ _ t' t'' _ _ (SBase {}) (SPoly {}) = impossible ""
...
{-@ lem_sub_trans_go_sfunc :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 1] @-}
lem_sub_trans_go_sfunc :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_go_sfunc  g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''@(SFunc {})
  = lem_sub_trans_sfunc g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans_go_sfunc   g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''@(SWitn {})
  = lem_sub_trans_switnR g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''
lem_sub_trans_go_sfunc g _ t _ _ t' t'' _ _ (SFunc {}) (SBase {}) = impossible ""
lem_sub_trans_go_sfunc g _ t _ _ t' t'' _ _ (SFunc {}) (SBind {}) = impossible ""
lem_sub_trans_go_sfunc g _ t _ _ t' t'' _ _ (SFunc {}) (SPoly {}) = impossible ""
...
{-@ lem_sub_trans_go_spoly :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 1] @-}
lem_sub_trans_go_spoly :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_go_spoly  g p_g_wf t k p_g_t t'  t'' k'' p_g_t'' p_t_t' p_t'_t''@(SPoly {})
  = lem_sub_trans_spoly g p_g_wf t k p_g_t t'  t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans_go_spoly   g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''@(SWitn {})
  = lem_sub_trans_switnR g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''
lem_sub_trans_go_spoly g _ t _ _ t' t'' _ _ (SPoly {}) (SBase {}) = impossible ""
lem_sub_trans_go_spoly g _ t _ _ t' t'' _ _ (SPoly {}) (SFunc {}) = impossible ""
lem_sub_trans_go_spoly g _ t _ _ t' t'' _ _ (SPoly {}) (SBind {}) = impossible ""
...
{-@ lem_sub_trans_go_switn :: g:Env -> ProofOf(WFEnv g) -> t:Type -> k:Kind -> ProofOf(WFType g t k)
            ...
            -> { p_t_t'':Subtype  | propOf p_t_t''  == Subtype g t  t'' }
             / [tdepth t + tdepth t' + tdepth t'', 1] @-}
lem_sub_trans_go_switn :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans_go_switn   g p_g_wf t k p_g_t t'  t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''@(SWitn {})
  = lem_sub_trans_switnR g p_g_wf t k p_g_t t'  t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''
lem_sub_trans_go_switn      g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''@(SBind {})
  = lem_sub_trans_switnbind g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans_go_switn g _ t _ _ t' t'' _ _ (SWitn {}) (SBase {}) = impossible ""
lem_sub_trans_go_switn g _ t _ _ t' t'' _ _ (SWitn {}) (SFunc {}) = impossible ""
lem_sub_trans_go_switn g _ t _ _ t' t'' _ _ (SWitn {}) (SPoly {}) = impossible ""
...
lem_sub_trans :: Env -> WFEnv -> Type -> Kind -> WFType -> Type 
                     -> Type -> Kind -> WFType -> Subtype -> Subtype -> Subtype
lem_sub_trans g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t'@(SBase {}) p_t'_t'' 
  = lem_sub_trans_go_sbase g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t'@(SFunc {}) p_t'_t''
  = lem_sub_trans_go_sfunc g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t'@(SPoly {}) p_t'_t'' 
  = lem_sub_trans_go_spoly g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t'@(SWitn {}) p_t'_t'' 
  = lem_sub_trans_go_switn g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_t_t' p_t'_t''
lem_sub_trans g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t'@(SBind {}) p_g_t'_t'' 
  = lem_sub_trans_sbindL g p_g_wf t k p_g_t t' t'' k'' p_g_t'' p_g_t_t' p_g_t'_t''
