...
Proof. induction g; intros; inversion H4. 
  ...
  - (* ECons *) subst x0 t1 g0; try rewrite lem_unroll_csubst_env_left;
    ...
    assert (FCons x (erase (ctsubst th0 t)) FEmpty 
              = erase_env (csubst_env th0 (ECons x t Empty)))
    ...
    pose proof (lem_binds_concat (ECons x t Empty) g'); 
  ...
  - (* EConsT *) subst a0 k0 g0; simpl; apply IHg;
    try rewrite lem_erase_concat;
...
Proof. induction g; intros.
  ...
  - (* ECons *)  inversion H4; subst x0 t1 g0;
    ...
    assert (ECons x (ctsubst th0 t) Empty = csubst_env th0 (ECons x t Empty))
  ...
  - (* EConsT *) inversion H4; subst a0 k1 g0; simpl;
