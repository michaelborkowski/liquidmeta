...
Lemma lem_csubst_nil : forall (th:csub) (t0 : type),
    csubst th (Nil t0) = Nil (ctsubst th t0).
Proof. induction th; intros; simpl; apply IHth || reflexivity. Qed.

Lemma lem_csubst_cons : forall (th:csub) (t0:type) (eH eT:expr),
    csubst th (Cons t0 eH eT) = Cons (ctsubst th t0) (csubst th eH) (csubst th eT).
Proof. induction th; simpl; intros; apply IHth || reflexivity. Qed.
