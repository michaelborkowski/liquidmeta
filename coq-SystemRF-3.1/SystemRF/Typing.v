...
Fixpoint safeListVarUseE (x:vname) (e : expr) : Prop  :=
    ...
    | Nil t0          => safeListVarUseT x t0
    | (Cons t0 e1 e2) => safeListVarUseT x t0 /\ safeListVarUseE x e1 
                                             /\ safeListVarUseE x e2 
