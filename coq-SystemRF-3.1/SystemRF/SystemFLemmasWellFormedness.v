...
Proof. apply ( WFFT_ind 
  ...
  - (* WFFTList *) intros; apply WFFTList with k_t; apply H0; assumption .
...
Lemma lem_weaken_wfft_top : forall (g : fenv) (t : ftype) (k : kind) (x : vname) (t_x : ftype),
    WFFT g t k -> ~ (in_envF x g) -> WFFT (FCons x t_x g) t k.
Proof. intros; assert (FCons x t_x g = concatF (FCons x t_x g) FEmpty) by reflexivity;
  rewrite H1; apply lem_weaken_wfft; simpl; try apply intersect_empty_r; intuition. Qed.
...
Proof. apply ( WFFT_ind 
  ...
  - (* WFFTList *) intros; apply WFFTList with k_t; fold ftsubFV;
      apply H0 with k_a; assumption.
...
Proof. intros g e t p_e_t p_g. induction p_e_t.
  ...
  - (* FTNil *) apply WFFTList with k; apply H4.
  - (* FTCons *) apply IHp_e_t2; apply p_g.
  - (* FTSwit *) apply IHp_e_t2; apply p_g.
  Qed.