...
Proof. apply ( WFtype_ind 
  ...
  - (* WFList *) repeat rewrite lem_self_star; apply lem_sub_refl with Star;
    rewrite <- H1; apply WFList with k_t; apply H.
  - (* WFListR *) repeat rewrite lem_self_star; apply lem_sub_refl with Star;
    rewrite <- H3; apply WFListR with nms; assumption.
