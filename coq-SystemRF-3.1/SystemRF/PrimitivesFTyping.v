...
Proof. induction v; intros; inversion H; inversion H0; 
  ...
  - (* v = Nil *) simpl; apply I.
  - (* v = Cons v1 v2 *) simpl; apply IHv2 with (erase t); assumption.
  Qed.
...
Proof. intros c rt v t Hmeas Hval. induction Hval; intros;
  ...
  inversion H5; (rewrite H24; apply H3) || apply H32. Qed.
...
Proof. intros c k s v t Hmeas Hval. induction Hval; intros;
  ...
  - (* v = Cons v1 v2*) apply IHHval2 in H; subst t; try apply H12.
