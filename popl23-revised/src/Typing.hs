...
{-@ data HasType where
        ...
        TApp  :: g:Env -> e:Expr -> t_x:Type -> t:Type -> ProofOf (HasType g e (TFunc t_x t))
        ...
        TSub  :: g:Env -> e:Expr -> s:Type -> ProofOf (HasType g e s)
                  -> t:Type -> k:Kind -> ProofOf(WFType g t k) -> ProofOf (Subtype g s t)
