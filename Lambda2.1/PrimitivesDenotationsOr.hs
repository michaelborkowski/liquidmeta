...
lem_den_or :: Denotes
lem_den_or = DFunc 1 (TRefn TBool Z (Bc True)) t' (Prim Or) (FTPrm FEmpty Or) val_den_func
  where
    ...
    t't = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc True)) (BV 2)) )
    den_t't_lamtt = DFunc 2 (TRefn TBool Z (Bc True)) t't (Lambda 1 (Bc True))
    ...
    val_den_func3 v_x den_tx_vx = case v_x of
      ...
      _          -> impossible ("by lemma" ? lem_den_bools v_x (TRefn TBool Z (Bc True)) den_tx_vx)
    t'''t = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc True)) (Bc True)) )
    t'''f = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc True)) (Bc False)) )
    den_t'''t_tt = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc True)) (Bc True)) )
    ...
    den_t'''f_tt = DRefn TBool Z(App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc True)) (Bc False)) )
    ...
    t'f = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc False)) (BV 2)) )
    den_t'f_id = DFunc 2 (TRefn TBool Z (Bc True)) t'f (Lambda 1 (BV 1)) 
    ...
    val_den_func2 v_x den_tx_vx = case v_x of 
      ...
      _          -> impossible ("by lemma" ? lem_den_bools v_x (TRefn TBool Z (Bc True)) den_tx_vx)
    t''t = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc False)) (Bc True)) )
    t''f = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc False)) (Bc False)) )
    den_t''t_tt = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc False)) (Bc True)) )
                        (Bc True) (FTBC FEmpty True) or_ev_prt''t_tt
    ...
    den_t''f_ff = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim Or) (Bc False)) (Bc False)) )
