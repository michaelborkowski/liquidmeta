...
--        (WFEBindT _ pg_wf _ _) = p_ag_wf
        ...
        p_er_wenv_wf     = WFFBind (erase_env env) p_er_env_wf (fresh_var env) (FTBasic b) 
                       ...
                       ? ( concatF (FConsT a k_a (erase_env g)) (FCons (fresh_var env) (FTBasic b) (erase_env g'))
                       === FCons (fresh_var env) (FTBasic b) (concatF (FConsT a k_a (erase_env g)) (erase_env g'))
                       === FCons (fresh_var env) (FTBasic b) (concatF (erase_env (ConsT a k_a g)) (erase_env g'))
                         ? lem_erase_concat (ConsT a k_a g) g'
                       === FCons (fresh_var env) (FTBasic b) (erase_env (concatE (ConsT a k_a g) g')) )
        p_er_yenv_wf     = WFFBind (erase_env env) p_er_env_wf (y ? binds_pf) (FTBasic b) 
                       ...
                       === FCons y (FTBasic b) (concatF (FConsT a k_a (erase_env g)) (erase_env g'))
                       === FCons y (FTBasic b) (concatF (erase_env (ConsT a k_a g)) (erase_env g'))
                         ? lem_erase_concat (ConsT a k_a g) g'
                       === FCons y (FTBasic b) (erase_env (concatE (ConsT a k_a g)  g')) )
        ...
        pf_p1ta_bl       = lem_subst_tv_ftyp (erase_env g) (FCons y (FTBasic b) (erase_env g' ? binds_pf'))
        ...
        pf_p2ta_bl       = lem_subst_tv_ftyp (erase_env g) (FCons y (FTBasic b) (erase_env g' ? binds_pf')) 
        ...
        concF_yenv       =   concatF (FCons y (FTBasic b) (erase_env env)) FEmpty
                         === FCons y (FTBasic b) (erase_env env)
