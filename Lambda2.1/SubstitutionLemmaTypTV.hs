...
{-@ lem_subst_tv_typ_tvar3 :: g:Env -> { g':Env | Set_emp (Set_cap (binds g) (binds g')) } 
        ...
        -> ProofOf(HasType (concatE g (esubFTV a t_a g')) (subFTV a t_a e) (tsubFTV a t_a t)) 
               / [typSize p_e_t, 0] @-}
lem_subst_typ_tv_tvar3 :: Env -> Env -> Vname -> Type -> Kind -> WFType -> WFEnv
                    -> Expr -> Type -> HasType -> HasType
lem_subst_typ_tv_tvar3 g g' a t_a k_a p_g_ta p_env_wf e t p_env_z_t@(TVar3 env_ z _t p_z_t a'_ k_a') 
