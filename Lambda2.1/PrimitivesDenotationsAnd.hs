...
{-@ reflect t'_and @-}
t'_and :: Type
t'_and = TFunc 2 (TRefn TBool Z (Bc True)) (TRefn TBool Z (App (App (Prim Eqv) (BV 0))
...
lem_den_and :: Denotes
lem_den_and = DFunc 1 (TRefn TBool Z (Bc True)) t'_and (Prim And) (FTPrm FEmpty And) val_den_func_and

{-@ val_den_func_and :: v_x:Value -> ProofOf(Denotes (TRefn TBool Z (Bc True)) v_x) 
                                  -> ProofOf(ValueDenoted (App (Prim And) v_x) (tsubBV 1 v_x t'_and)) @-}
val_den_func_and :: Expr -> Denotes -> ValueDenoted
val_den_func_and v_x den_tx_vx = case v_x of 
      (Bc True)  -> ValDen (App (Prim And) (Bc True)) (tsubBV 1 (Bc True) t'_and) (Lambda 1 (BV 1)) 
                      (lem_step_evals (App (Prim And) (Bc True)) (Lambda 1 (BV 1)) 
                                      (EPrim And (Bc True))) den_t'andt_id
      (Bc False) -> ValDen (App (Prim And) (Bc False)) (tsubBV 1 (Bc False) t'_and) (Lambda 1 (Bc False)) 
                      (lem_step_evals (App (Prim And) (Bc False)) (Lambda 1 (Bc False)) 
                                      (EPrim And (Bc False))) den_t'andf_lamff
      _     -> impossible ("by lemma" ? lem_den_bools v_x (TRefn TBool Z (Bc True)) den_tx_vx)

{-@ den_t'andt_id :: ProofOf(Denotes (tsubBV 1 (Bc True) (t'_and)) (Lambda 1 (BV 1))) @-}
den_t'andt_id :: Denotes
den_t'andt_id = DFunc 2 (TRefn TBool Z (Bc True)) (t'andb True) (Lambda 1 (BV 1)) 
                   (FTAbs FEmpty 1 (FTBasic TBool) Base (WFFTBasic FEmpty TBool) (BV 1) 
                          (FTBasic TBool) 1 (FTVar1 FEmpty 1 (FTBasic TBool))) val_den_func_and2

{-@ val_den_func_and2 :: v_x:Value -> ProofOf(Denotes (TRefn TBool Z (Bc True)) v_x)
                           -> ProofOf(ValueDenoted (App (Lambda 1 (BV 1)) v_x) (tsubBV 2 v_x (t'andb True))) @-}
val_den_func_and2 :: Expr -> Denotes -> ValueDenoted
val_den_func_and2 v_x den_tx_vx = case v_x of 
      (Bc True)  -> ValDen (App (Lambda 1 (BV 1)) (Bc True)) (tsubBV 2 (Bc True) (t'andb True)) (Bc True)
                      (lem_step_evals (App (Lambda 1 (BV 1)) (Bc True)) (Bc True) 
                                      (EAppAbs 1 (BV 1) (Bc True))) den_t''t_tt 
      (Bc False) -> ValDen (App (Lambda 1 (BV 1)) (Bc False)) (tsubBV 2 (Bc False) (t'andb True)) (Bc False)
  ...
  where
    ...
    p''t = App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc True)) (Bc True)) 
    p''f = App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc True)) (Bc False)) 

{-@ den_t'andf_lamff :: ProofOf(Denotes (tsubBV 1 (Bc False) (t'_and)) (Lambda 1 (Bc False))) @-}
den_t'andf_lamff :: Denotes
den_t'andf_lamff = DFunc 2 (TRefn TBool Z (Bc True)) (t'andb False) (Lambda 1 (Bc False))
...
{-@ val_den_func_and3 :: v_x:Value -> ProofOf(Denotes (TRefn TBool Z (Bc True)) v_x)
                           -> ProofOf(ValueDenoted (App (Lambda 1 (Bc False)) v_x) (tsubBV 2 v_x (t'andb False))) @-}
val_den_func_and3 :: Expr -> Denotes -> ValueDenoted
val_den_func_and3 v_x den_tx_vx = case v_x of
      (Bc True)  -> ValDen (App (Lambda 1 (Bc False)) (Bc True)) (tsubBV 2 (Bc True) (t'andb False)) (Bc False)
                      (lem_step_evals (App (Lambda 1 (Bc False)) (Bc True)) (Bc False) 
                                      (EAppAbs 1 (Bc False) (Bc True))) den_t'''t_ff
      (Bc False) -> ValDen (App (Lambda 1 (Bc False)) (Bc False)) (tsubBV 2 (Bc False) (t'andb False)) (Bc False)
  ...
  where
    ...
    p'''t = App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc False)) (Bc True))
    p'''f = App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc False)) (Bc False))
