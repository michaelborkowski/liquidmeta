...
lem_widen_denotes g (Cons z t_z g') x s_x t_x p_sx_tx k_tx p_g_tx p_env_wf th den_env_th 
  = case den_env_th of
        ...
        -> DExt env0' th0 den_env0'_th0 z t_z v_z den_th0tz_vz
             where
               ...
               den_env0'_th0 = lem_widen_denotes g g' x s_x t_x p_sx_tx k_tx p_g_tx p_env0_wf
                                                 th0 den_env0_th0
lem_widen_denotes g (ConsT a k g')  x s_x t_x p_sx_tx k_tx p_g_tx p_env_wf th den_env_th 
  = case den_env_th of
