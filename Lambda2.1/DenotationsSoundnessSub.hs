...
{-@ lem_denote_sound_sub_sbase :: g:Env -> t1:Type -> k1:Kind -> t2:Type -> k2:Kind 
                ...
                -> { th:CSub | same_binders_cs th t1 && same_binders_cs th t2 }
...
{-@ lem_denote_sound_typ_tvar1 :: g:Env -> e:Expr -> t:Type 
                ...
                -> ProofOf(WFEnv g) -> { th:CSub | same_binders_csE th e } -> ProofOf(DenotesEnv g th)  
  ...
  = ValDen (csubst th e) (ctsubst th t) v'' ev_the_v'' den_tht_v''
      where
        ...
        (ValDen _ _ v'' ev_v'tht'_v'' den_tht_v'') = prover (ctsubst th t') p_emp_tht'
                        ? lem_ctsubst_tsubBTV a (ctsubst th t') k p_emp_tht' th s
...
{-@ lem_denote_sound_typ :: g:Env -> e:Expr -> t:Type 
                ...
                -> { th:CSub | same_binders_csE th e } -> ProofOf(DenotesEnv g th)  
