...
lem_denote_sound_sub_sbase g t1 k1 t2 k2 (SBase _g x1 b p1 x2 p2 y pf_ent_p2) p_g_wf p_g_t1 p_g_t2
                    -- t1 = b{x1:p1}, t2 = b{x2:p2}  -- Pf(Entails g' p2[y/x2])
                       th den_g_th val_ den_t1_v = undefined {-
  = case den_t1_v of
...
lem_denote_sound_sub_sfunc g t1 k1 t2 k2 p_t1_t2@(SFunc _g x1 s1 x2 s2 p_g_s2_s1 t1' t2' y p_g'_t1_t2) 
                           p_g_wf p_g_t1 p_g_t2 th den_g_th _v den_tht1_v = undefined {-
  = case den_tht1_v of       -- p_t1_t2 :: Subtype (Cons y s2 g) t1'[y/x1] t2'[y/x2]
      (DFunc _x1 ths1 tht1' val pf_v_er_tht1 _pf_den_tht1'_vv')
        -> DFunc x2 (ctsubst th s2) (ctsubst th t2') val (pf_v_er_tht2 ? lem_ctsubst_func th x2 s2 t2')
          ...
          where
            ...
            pf_v_er_tht2 = lem_alpha_eqv_ftyp FEmpty val (erase (ctsubst th t1)) pf_v_er_tht1
                               (erase (ctsubst th t2)) (lem_erase_th_sub g t1 t2 p_t1_t2 th)
            ...
            pf_den_tht2'_vv' v'_ den_ths2_v' = ValDen (App val v') (tsubBV x2 v' (ctsubst th t2'))
              ...
              where
                ...
                pf_v'_er_s1    = lem_alpha_eqv_ftyp FEmpty v' (erase (ctsubst th s2)) pf_v'_er_s2
                                     (erase (ctsubst th s1)) (lem_erase_th_sub g s2 s1 p_g_s2_s1 th)
                ...
                (ValDen _ _ v'' evalpf denpf) = get_obj_from_dfunc x1 (ctsubst th s1) (ctsubst th t1') 
                         ...
                         (ths2_ths1 v' (den_ths2_v' `withProof` lem_ctsubst_func th x2 s2 t2')
                                                    `withProof` lem_ctsubst_func th x1 s1 t1')
                pf_vv'_er_t1'  = FTApp FEmpty val (erase (ctsubst th s1)) 
                                       (erase (ctsubst th t1')) pf_v_er_tht1
                                       v' (get_ftyp_from_den (ctsubst th s2) v' den_ths2_v')
                ...
                den_t2'v'_v''  = tht1'_tht2' th' den_g'_th' v'' 
                                      ...
                                      `withProof` lem_ctsubst_and_unbindT x2 y v' 
                                          (erase (ctsubst th s2)) 
                                          (get_ftyp_from_den (ctsubst th s2) v' den_ths2_v') 
                                          th t2'
...
lem_denote_sound_sub_switn g t1 k1 t2 k2 -- @(TExists x t_x t')  -----------------------------------
             ...
             p_g_wf p_g_t1 p_g_t2 th den_g_th v den_tht1_v = undefined {-
...
lem_denote_sound_sub_sbind g t1 k1 t2 k2 -- t1 == (TExists x t_x t') 
             p_t1_t2@(SBind _g x t_x t' _t2 y p_t'yx_t2) p_g_wf p_g_t1 p_g_t2 th den_g_th v den_tht1_v =undefined {-
...
lem_denote_sound_sub_spoly g t1 Star t2 Star p_t1_t2@(SPoly _g a1 k t1' a2 t2' a p_ag_t1'_t2')
                           p_g_wf p_g_t1 p_g_t2 th den_g_th _v den_tht1_v = undefined {-
  = case den_tht1_v of   
      (DPoly _a1 _k tht1' val pf_v_er_tht1 _pf_den_tht1'_vta)
        -> DPoly a2 k (ctsubst th t2') val (pf_v_er_tht2 ? lem_ctsubst_poly th a2 k t2') pf_den_tht2'_vta
            ...
            pf_den_tht2'_vta t_a_ p_emp_ta = ValDen (AppT val t_a) (tsubBTV a2 t_a (ctsubst th t2'))
              ...
              where
                t_a              = t_a_ ? lem_free_subset_binds Empty t_a_ k p_emp_ta
                                        ? lem_tfreeBV_empty     Empty t_a_ k p_emp_ta WFEEmpty
...
{-@ lem_denote_sound_typ_tvar1 :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTVar1 p_e_t } 
             ...
             where
               ...
               den_tht_thx = lem_denotations_selfify (ctsubst th' t') k' w w (Refl w) den_th't'_w               
                                        ...
                                        ? toProof ( ctsubst (CCons x w th') t'
                                                ...
                                                === ctsubst th' t' )
                                        ? lem_ctsubst_self th t' x k'

{-@ lem_denote_sound_typ_tvar2 :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTVar2 p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
lem_denote_sound_typ_tvar2 :: Env -> Expr -> Type -> HasType -> WFEnv -> CSub 
                            -> DenotesEnv -> ValueDenoted
lem_denote_sound_typ_tvar2 g e t p_e_t@(TVar2 g' x _t p_x_t y t_y) 
                     wf_g@(WFEBind _ wf_g' _ _ _ p_g'_ty) th den_g_th  -- TODO
...
{-@ lem_denote_sound_typ_tvar3 :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTVar3 p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
lem_denote_sound_typ_tvar3 :: Env -> Expr -> Type -> HasType -> WFEnv -> CSub 
                            -> DenotesEnv -> ValueDenoted
lem_denote_sound_typ_tvar3 g e t p_e_t@(TVar3 g' x _t p_x_t a k_a) 
                     wf_g@(WFEBindT _ wf_g' _ _) th den_g_th = undefined

{-@ lem_denote_sound_typ_tabs :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTAbs p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
...
{-@ lem_denote_sound_typ_tapp :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTApp p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
...
{-@ lem_denote_sound_typ_tabst :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTAbsT p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
lem_denote_sound_typ_tabst :: Env -> Expr -> Type -> HasType -> WFEnv -> CSub 
                            -> DenotesEnv -> ValueDenoted
lem_denote_sound_typ_tabst g e t (TAbsT {}) p_g_wf th den_g_th = undefined

{-@ lem_denote_sound_typ_tappt :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTAppT p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
lem_denote_sound_typ_tappt :: Env -> Expr -> Type -> HasType -> WFEnv -> CSub 
                            -> DenotesEnv -> ValueDenoted
lem_denote_sound_typ_tappt g e t (TAppT {}) p_g_wf th den_g_th = undefined

{-@ lem_denote_sound_typ_tlet :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTLet p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
...
{-@ lem_denote_sound_typ_tann :: g:Env -> e:Expr -> t:Type 
                -> { p_e_t:HasType | propOf p_e_t == HasType g e t && isTAnn p_e_t } 
                -> ProofOf(WFEnv g) -> th:CSub -> ProofOf(DenotesEnv g th)  
                -> ProofOf(ValueDenoted (csubst th e) (ctsubst th t)) / [typSize p_e_t, 0] @-}
...
lem_denote_sound_typ :: Env -> Expr -> Type -> HasType -> WFEnv -> CSub 
                            -> DenotesEnv -> ValueDenoted
lem_denote_sound_typ g e t p_e_t@(TBC _g b) p_g_wf th den_g_th  = undefined {- CHECKED
...
-}
lem_denote_sound_typ g e t p_e_t@(TIC _g n) p_g_wf th den_g_th  = undefined {- CHECKED
...
lem_denote_sound_typ g e t p_e_t@(TPrm _g c) p_g_wf th den_g_th = undefined {- CHECKED
...
lem_denote_sound_typ g e t (TSub _g _e s p_e_s _t k p_g_t p_s_t) p_g_wf th den_g_th = undefined {- CHECKED
  = ValDen (csubst th e) (ctsubst th t) v ev_the_v den_tht_v
    where
