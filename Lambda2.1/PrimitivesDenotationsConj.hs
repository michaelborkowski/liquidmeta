...
lem_den_conj = DFunc 1 (TRefn TBool Z (Bc True)) t'
  ...
  where
    ...
    t' = TFunc 2 (TRefn TBool Z (Bc True)) (TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (BV 1)) (BV 2)) ))
    ...
    den_t''t_tt = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc True)) (Bc True)) )
    ...
    den_t''f_ff = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc True)) (Bc False)) )
    ...
    t'f = TRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc False)) (BV 2)) )
    ...
    den_t'''t_ff = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc False)) (Bc True)) )
    ...
    den_t'''f_ff = DRefn TBool Z (App (App (Prim Eqv) (BV 0)) (App (App (Prim And) (Bc False)) (Bc False)) )
                        (Bc False) (FTBC FEmpty False) ev_prt'''f_ff
