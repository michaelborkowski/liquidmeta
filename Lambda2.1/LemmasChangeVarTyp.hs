        ...
        (Cons _w _tw g'') -> case (x == z) of
                    ...
                    (False) -> TVar2 (concatE (Cons y t_x g) (esubFV x (FV y) g''))
                      ...
                      where
                        (WFEBind env' p_env'_wf _ _ _) = p_env_wf
-}
lem_change_var_typ g x t_x g' p_env_wf e t (TVar3 _ z _t p_z_t a' k_a') y = undefined
...
lem_change_var_typ g x t_x g' p_env_wf e t (TAbsT {}) y = undefined
lem_change_var_typ g x t_x g' p_env_wf e t (TAppT {}) y = undefined
...
lem_change_var_subtype g x t_x g' p_env_wf t k p_env_t t' k' p_env_t' 
                       (SBase env z1 b p1 z2 p2 w pf_wenv_ent_p2) y_ = undefined {-
...
lem_change_var_subtype g x t_x g' p_env_wf ft1 k1 p_env_ft1 ft2 k2 p_env_ft2 
                       (SFunc env z1 s1 z2 s2 p_env_s2_s1 t1 t2 w p_wenv_t1_t2) y_ = undefined {-
    = case p_env_ft1 of
...
lem_change_var_subtype g x t_x g' p_env_wf t1 k1 p_env_t1 t' k' p_env_t'
                       (SBind env z t_z t _t' z' p_z'env_t_t') y_ = undefined {-
    = case p_env_t1 of 
          ...
          -> SBind env' z (tsubFV x (FV y) t_z) (tsubFV x (FV y) t) (tsubFV x (FV y) t') 
               ...
               where
                   ...
                   p_z''env'_t_t' = lem_change_var_subtype g x t_x (Cons z'' t_z g') p_z''env_wf
                                            ...
                                            ? lem_commute_tsubFV_unbindT x y z z'' t
-}
lem_change_var_subtype g x t_x g' p_env_wf t1 k1 p_env_t1 t' k' p_env_t' (SPoly {}) y_ = undefined
