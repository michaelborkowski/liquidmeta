...
lem_typing_wf g e t (TVar1 _g' x t') p_wf_g -- x:t',g |- (FV x) : t == self(t')
    = case p_wf_g of
...
lem_freeBV_empty g e t (TAbs _g x t_x k_x 	p_g_tx e' t' y p_yg_e'_t') p_g_wf
    = () -- ? lem_tfreeBV_empty g t_x k_x p_g_tx p_g_wf -- restore later?
