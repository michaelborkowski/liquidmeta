...
{-@ lem_sub_refn_pred_leq :: n:Int -> { pf:_ | subBV 1 (Ic n) (refn_pred Leq)
                             == App (App (Prim Eqv) (BV 0)) (App (App (Prim Leq) (Ic n)) (BV 2)) } @-}
