...
lem_typing_wf g e t (TLet _g e_x t_x p_ex_tx x e' _t p_g_t y p_e'_t) p_wf_g 
    = p_g_t
...
lem_typing_hasftype g e t (TLet _g e_x t_x p_ex_tx x e' _t p_g_t y p_yg_e'_t) p_g_wf
...
lem_typing_hasftype g e t (TAnn _g e' _ p_e'_t) p_g_wf
    = FTAnn (erase_env g) e' (erase t) (t ? lem_free_subset_binds g t p_t_wf
                                          ? lem_tfreeBV_empty g t p_t_wf)
...
lem_fv_bound_in_env g e t (TLet _g e_y t_y p_ey_ty y e' t' p_g_t' y' p_e'_t') p_g_wf x 
    = case ( x == y' ) of
...
lem_fv_subset_binds g e t (TLet _g e_y t_y p_ey_ty y e' t' p_g_t' y' p_e'_t') p_g_wf
...
lem_freeBV_empty g e t (TLet _g e_x t_x p_ex_tx x e' _t p_g_t y p_yg_e'_t) p_g_wf = case e of
  (Let _ _ _) -> () 
        ? lem_freeBV_empty g e_x t_x p_ex_tx p_g_wf
