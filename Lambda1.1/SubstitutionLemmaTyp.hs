...
lem_subst_typ_tlet :: Env -> Env -> Vname -> Expr -> Type -> HasType -> WFEnv
                    -> Expr -> Type -> HasType -> HasType
lem_subst_typ_tlet g g' x v_x t_x p_vx_tx p_env_wf e t (TLet env_ e_z t_z p_env_ez_tz z e' t_ 
...
lem_subst_typ g g' x v_x t_x p_vx_tx p_env_wf e t p_e_t@(TLet env_ e_z t_z p_env_ez_tz z e' t_ 
                                                        p_env_t y_ p_yenv_e'_t) 
