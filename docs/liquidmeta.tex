...
\begin{mathpar}
\inferrule*[Right=WF-Base]{\Gamma, v\bind b \vdash e : \Bool}
{\Gamma \vdash_w b\{v\col e\}}\and
...
{\Gamma, v_1\bind b\{v_1\col p_1\} \vdash_e p_2[v_1/v_2]}
{\Gamma \vdash b\{v_1\col p_1\} <: b\{v_2\col p_2\}} \and 
...
{\Gamma \vdash_e \forall\, v\bind p \Rightarrow c}
{\Gamma, v\bind b\{v\col p\} \vdash_e c}
\end{mathpar}
...
Let $\theta' = (\theta,v_1\mapsto v)$. Then $\theta'(p_1) = \theta(p_1[v/v_1]) \many \true$.
From (4) we have
$\theta(p_2[v/v_2]) = \theta((p_2[v_1/v_2])[v/v_1])
= \theta'(p_2[v_1/v_2]) \many \true$,
and so $e$ lies in set (3) proving the desired containment.
